...
1. **In Xcode Project Navigator**, expand the "clara-provider-app" folder
...
5. **Check the box** next to **"clara-provider-app"** (this applies to ALL selected files)
...
5. Click the **"+"** button
6. In the file picker, navigate to "clara-provider-app" folder
