    ...
    var body: some View {
        NavigationStack {
            VStack(spacing: 0) {
                ...
                // Input area
                VStack(spacing: 8) {
                    // API key is hardcoded, so always show input
            ...
            // API key alert removed - using hardcoded key
            ...
            .onAppear {
                // API key is now hardcoded in ClaudeChatService
                // No need to load from UserDefaults
            }
        }
    }
