# Product Requirements Document: clara-provider-app iOS App
...
### 1.1 Product Vision
clara-provider-app is an iOS application that enables healthcare providers to efficiently review, respond to, and manage patient triage requests generated by the Clara AI health assistant platform. The app serves as the provider-facing counterpart to the patient-facing Clara iOS app, facilitating real-time clinical decision support and patient communication.
